  ...
  return (
    <div>
        ...
        {/* ----Total Bookings---- */}
          ...
          <img className='max-sm:hidden h-10' src={assets.totalBookingIcon} alt="totalBookingIcon" />
          ...
          {/* -----Total Revenue------ */}
         <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
          <img className='max-sm:hidden h-10' src={assets.totalRevenueIcon} alt="totalBookingIcon" />
          <div className='flex flex-col sm:ml-4 font-medium'>
